    ...
    const STEPS = [
      {
        ...
        title: 'Build Your Devotion Plan',
        body: "Tap this + button any time to build a 7-day plan. Every Sunday you'll get a reminder to set up the next week — so you're never without content.",
      },
      {
        route: '/', selector: '.home-greeting', calloutPos: 'below', highlightPadding: 10,
        title: 'Your Daily Devotion',
        body: "Each day opens with a personalized greeting and devotion. Morning and evening sessions are generated by AI, shaped by the trusted teachers you choose.",
      },
      {
      ...
      },
      {
        ...
        body: "Enter any topic — a theme, a life season, or a scripture passage — then tap this button to generate your full 7-day plan. You can dictate your topic too.",
      },
      {
      ...
      },
      {
        ...
        body: "Enable, disable, or add teachers whose theological style shapes your devotions. Your list is used every time AI generates content for you.",
      },
    ];
